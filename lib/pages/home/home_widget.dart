      ...
      builder: (context) => GestureDetector(
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            top: true,
            child: Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 49.0),
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          StreamBuilder<List<AllUserBalancesRecord>>(
                            stream: queryAllUserBalancesRecord(
                              queryBuilder: (allUserBalancesRecord) =>
                                  allUserBalancesRecord.where(
                                'userId',
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<AllUserBalancesRecord>
                                  chartAllUserBalancesRecordList =
                                  snapshot.data!;
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: FlutterFlowLineChart(
                                    data: [
                                      FFLineChartData(
                                        xData: chartAllUserBalancesRecordList
                                            .map((d) => d.retrievedAt)
                                            .toList(),
                                        yData: chartAllUserBalancesRecordList
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed(AddBalanceWidget.routeName);
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        '${valueOrDefault(currentUserDocument?.cashInHand, 0.0).toString()} ETB',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.poppins(
                              ...
                              InkWell(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        '${valueOrDefault(currentUserDocument?.bankBalance, 0.0).toString()} USD',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.poppins(
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<List<SavingPlanRecord>>(
                        stream: querySavingPlanRecord(
                          queryBuilder: (savingPlanRecord) =>
                              savingPlanRecord.where(
                            'uid',
                            isEqualTo: currentUserUid,
                          ),
                          limit: 6,
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<SavingPlanRecord> rowSavingPlanRecordList =
                              snapshot.data!;
                          if (rowSavingPlanRecordList.isEmpty) {
                          ...
                          return SingleChildScrollView(
                            ...
                            child: Row(
                              ...
                              children: List.generate(
                                  rowSavingPlanRecordList.length, (rowIndex) {
                                final rowSavingPlanRecord =
                                    rowSavingPlanRecordList[rowIndex];
                                return InkWell(
                                  splashColor: Colors.transparent,
                                  focusColor: Colors.transparent,
                                  hoverColor: Colors.transparent,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed(BudgetPageWidget.routeName);
                            },
                            child: Icon(
                              Icons.keyboard_arrow_right,
                              color: FlutterFlowTheme.of(context).primaryText,
                    ...
                    StreamBuilder<List<UserBudgetsRecord>>(
                                ...
                                Row(
                                  ...
                                  children: [
                                    CircularPercentIndicator(
                                      percent: columnUserBudgetsRecord
                                              .currentAmount /
                                ...
                                children: [
                                  ...
                                  RichText(
                                    ...
                                    text: TextSpan(
                                      children: [
                                        TextSpan(
                                          text: columnAllUserTransactionsRecord
                                                      .type ==
                                                  'deposit'
                                              ? '+'
                                              : '-',
