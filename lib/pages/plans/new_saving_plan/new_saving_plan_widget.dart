...
import 'new_saving_plan_model.dart';
export 'new_saving_plan_model.dart';

class NewSavingPlanWidget extends StatefulWidget {
  const NewSavingPlanWidget({super.key});

  static String routeName = 'new_saving_plan';
  static String routePath = '/newSavingPlan';

  @override
  State<NewSavingPlanWidget> createState() => _NewSavingPlanWidgetState();
}

class _NewSavingPlanWidgetState extends State<NewSavingPlanWidget> {
  late NewSavingPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewSavingPlanModel());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await SavingPlanRecord.collection
                            .doc()
                            .set(createSavingPlanRecordData(
