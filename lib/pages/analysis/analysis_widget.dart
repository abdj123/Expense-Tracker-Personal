...
class _AnalysisWidgetState extends State<AnalysisWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await _model.callAnalysis(context);
      safeSetState(() {});
    });
