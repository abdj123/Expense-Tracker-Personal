...
import 'connect_popup_bank_model.dart';
export 'connect_popup_bank_model.dart';

class ConnectPopupBankWidget extends StatefulWidget {
  const ConnectPopupBankWidget({
    super.key,
    required this.name,
  });
  ...
  @override
  State<ConnectPopupBankWidget> createState() => _ConnectPopupBankWidgetState();
}

class _ConnectPopupBankWidgetState extends State<ConnectPopupBankWidget> {
  late ConnectPopupBankModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConnectPopupBankModel());
              ...
              children: [
                    ...
                    children: [
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'siyjua2n' /* Connecting with Bank Account */,
                        ),
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'uqgwujux' /* Add Your Account API key to co... */,
                          ),
                          style:
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                validator: _model.apiKeyTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      _model.apiResultxul =
                          await TransactionsGroup.bankAccountsCall.call(
                        jwt: currentJwtToken,
                        name: widget!.name,
                ...
                Text(
                  FFLocalizations.of(context).getText(
                    'kqotidlz' /* By Clicking to Allow access, y... */,
                  ),
