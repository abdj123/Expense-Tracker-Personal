...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: AddBalanceWidget.routeName,
          path: AddBalanceWidget.routePath,
          requireAuth: true,
          builder: (context, params) => AddBalanceWidget(),
        ),
        FFRoute(
          name: CryptoAccountsWidget.routeName,
          path: CryptoAccountsWidget.routePath,
          builder: (context, params) => CryptoAccountsWidget(),
        ),
        FFRoute(
          name: PlanDetailPageWidget.routeName,
          path: PlanDetailPageWidget.routePath,
          builder: (context, params) => PlanDetailPageWidget(
            currentPlan: params.getParam(
              'currentPlan',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['saving_plan'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: NewSavingPlanWidget.routeName,
          path: NewSavingPlanWidget.routePath,
          builder: (context, params) => NewSavingPlanWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: BudgetPageWidget.routeName,
          path: BudgetPageWidget.routePath,
          requireAuth: true,
          builder: (context, params) => BudgetPageWidget(),
        ),
        FFRoute(
          name: ForegetPasswordWidget.routeName,
          path: ForegetPasswordWidget.routePath,
          builder: (context, params) => ForegetPasswordWidget(),
        ),
        FFRoute(
          name: NewBudgetWidget.routeName,
          path: NewBudgetWidget.routePath,
          requireAuth: true,
          builder: (context, params) => NewBudgetWidget(),
        ),
        FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Fictional_company_logo.png',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
